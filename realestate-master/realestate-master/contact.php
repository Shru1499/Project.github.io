...
<section class="faq" id="faq">
   ...
   <div class="box-container">
      ...
      <div class="box active">
         ...
         <p>For cancel your booking call our agent on tollfree No. 2269452565 .</p>
      </div>

      <div class="box active">
         <h3><span>when will I get the possession?</span><i class="fas fa-angle-down"></i></h3>
         <p> Any queries regarding properties call our agent or mail on our site. Tollfree no. 2269452565 		 .</p>
      </div>

      <div class="box">
         <h3><span>where can I pay the rent?</span><i class="fas fa-angle-down"></i></h3>
         <p>Contact the property agent..</p>
      </div>

      <div class="box">
         <h3><span>how to contact with the buyers?</span><i class="fas fa-angle-down"></i></h3>
         <p> Contact them. or Call in the office and get information about buyers.</p>
      </div>
